.summary = function(outfileLoc, fileName)
{
  ...
  return(list(readNum = readNum, readAlignedNum = readAligned, readAlignedRate = readAlignedRate, readFailedNum = readFailed, readFailedRate = readFailedRate, AlignNum = AlignNum))
}
